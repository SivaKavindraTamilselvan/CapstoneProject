...
@Component({
  selector: 'app-activate-vendor-user',
  imports: [],
  templateUrl: './activate-vendor-user.html',
  styleUrl: './activate-vendor-user.css',
})
export class ActivateVendorUser {
  ...
  constructor(private route: Router, private adminUserService: VendorUserService) {
