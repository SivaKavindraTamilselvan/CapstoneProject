...
namespace Ecommerce.Mappers
{
    public class ReturnMappingProfile : Profile
    {
        public ReturnMappingProfile()
        {
            ...
            .ForMember(dest => dest.ReturnAmount, opt => opt.MapFrom(src => src.ReturnRefund!.Refund!.ActualRefundAmount))
            .ForMember(dest => dest.AdminDamageCost, opt => opt.MapFrom(src => src.ReturnRefund.DamageCost))
