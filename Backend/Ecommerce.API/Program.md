...
// Key Vault wiring — pulls PostgresConnectionString, BlobStorageConnectionString,
// JwtKey, JwtIssuer, RazorpayKeyId, RazorpayKeySecret, ShiprocketEmail, ShiprocketPassword
...
builder.Services.AddSingleton(x =>
    new BlobServiceClient(builder.Configuration["BlobStorageConnectionString"]));
...
builder.Services.AddCors(options =>
{
    ...
    {
        builder.WithOrigins("http://localhost:7163", "http://localhost:4200", "http://localhost:5173","null","https://calm-field-0c96a3710.7.azurestaticapps.net" )
               .AllowAnyHeader()
               .AllowAnyMethod()
               .AllowCredentials();
    });
...
app.Run();
  ...
  //"KeyVaultName": "siva-ecommerce-key",
