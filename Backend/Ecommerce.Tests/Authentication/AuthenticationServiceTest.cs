...
public class AuthenticationServiceTest
{
    ...
    [Test]
    public async Task RegisterUser_ShouldCreateUserCartAndFavorites()
    {
        ...
        var user = await _context.User
            .FirstOrDefaultAsync(u => u.Email == "siva@test.com");
    ...
    public async Task RegisterUser_ShouldThrowException_WhenEmailAlreadyExists()
    {
        ...
        Assert.That(ex!.Message, Is.EqualTo("Email already found"));
    }
